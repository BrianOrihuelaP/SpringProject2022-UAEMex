...
public class controladorLibro {
    ...
    public ModelAndView qr (HttpServletRequest request) throws WriterException, FileNotFoundException, IOException, InterruptedException{
        ...
        File fichero = new File("E:\\UNI-USB\\DSISTEMAS\\biblioteca\\web\\img\\Qr.jpg");
        ...
        BufferedImage imagen = generaQR.crearQR("http://192.168.1.93:8080/Bilioteca/QRVistaLibro.htm?idLibro=" + idLibro, 300, 300);
